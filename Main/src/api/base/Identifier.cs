...
public class Identifier {
    public static readonly Endec<Identifier> ENDEC = endec.Endec.STRING.xmap(
        s => Identifier.of(s), 
    ...
    public static Identifier ofDomain(string Namespace, string domain, string suffix = "") {
        return of(Namespace, UriUtils.sanitizeName(domain) + suffix);
    }
